...
export default function Sidebar() {
 ...
 <div
        id="sidebar"
        className={`flex flex-col bg-[#494646] absolute z-40 left-0 top-0  lg:left-auto lg:top-auto lg:translate-x-0 h-full overflow-y-scroll lg:overflow-y-auto no-scrollbar w-64 lg:w-20 lg:min-h-screen lg:static lg:sidebar-expanded:!w-64 2xl:!w-64 shrink-0 p-4 transition-all duration-200 ease-in-out`}>
     {/* Sidebar header */}
